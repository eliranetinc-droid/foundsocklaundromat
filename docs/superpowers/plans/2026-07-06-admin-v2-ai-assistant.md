...
<html lang="en">
  ...
  <body class="bg-cream text-brand-blue-darker antialiased">
    <input type="checkbox" id="navToggle" class="peer hidden" />
    <div class="lg:grid lg:grid-cols-[16rem_1fr] min-h-screen">
      <!-- Sidebar -->
      <aside class="fixed inset-y-0 left-0 z-30 w-64 bg-brand-blue-darker text-white flex flex-col
                    -translate-x-full peer-checked:translate-x-0 transition-transform
      ...
      <label for="navToggle" class="fixed inset-0 z-20 bg-black/30 hidden peer-checked:block lg:hidden"></label>
        ...
        <header class="sticky top-0 z-10 bg-white border-b border-line">
          <div class="px-4 sm:px-6 h-14 flex items-center justify-between gap-3">
            <div class="flex items-center gap-3 min-w-0">
              <label for="navToggle" class="lg:hidden cursor-pointer text-xl leading-none px-1" aria-label="Menu">☰</label>
